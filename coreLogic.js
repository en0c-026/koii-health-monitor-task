...
class CoreLogic {
  ...
  async fetchSubmission() {
    ...
    console.log('Dashboard data CID', proof_cid, "in round", round - 1);
  ...
  async validateNode(submission_value, round) {
    ...
    // import the dashboard data validate module
    const vote = await dashboard_data_validate(submission_value, round);
